  ...
  useEffect(() => {
    const changeBtn = () => {
      if (location.pathname === "/profile" || location.pathname === "/settings")
        setButtonText("Home");
      else if (location.pathname === "/") setButtonText("Profile");
    };
    return () => {
      changeBtn();
    };
  ...
  return (
    <>
      <div className="navbarContainer">
        <div className="navbarLeft">
          <button onClick={routeSettings}>
            <MdSettings
              style={{ color: "white", fontSize: "30px", paddingTop: "5px" }}
            />
          </button>
      ...
      >
        ...
        >
          <ProfileMin userId="1" username="username" />
          <ProfileMin userId="2" username="username" />
          <ProfileMin userId="3" username="username" />
        </div>
      </div>
    </>
  );
