...
function Profile({ username, name, profilePic }) {
  ...
  return (
    <div className="profileContainer">
      <Navbar />
      <div
        className="followersDropdown"
        style={{ visibility: followersOpen ? "visible" : "hidden" }}
      >
        <Button
          style={{ margin: "10px", width: "100px", float: "right" }}
      ...
      <div
        className="followingDropdown"
        style={{ visibility: followingOpen ? "visible" : "hidden" }}
      >
        <Button
          style={{ margin: "10px", width: "100px", float: "right" }}
